...
1. CPC: Set password for SQL instance: 
...
1. CPC: Ensure Cloud SQL is not authorized for any other networks: 
...
1. CPC: Add the second instance group to the backend service (with balancing by requests per second)
